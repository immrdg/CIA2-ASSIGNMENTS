...
{
    QMessageBox::warning(this,"Gireesh 212218104044","This is a warning message");
}


void MainWindow::on_critical_clicked()
{
    QMessageBox::StandardButton reply=QMessageBox::question(this,"Gireesh 212218104044","This is a custom message",QMessageBox::Yes | QMessageBox::YesToAll | QMessageBox::No | QMessageBox::NoToAll);
    ...
    {
       QMessageBox::warning(this,"Gireesh 212218104044","Display the message with warning as YesToAll");
    }
    if(reply == QMessageBox::NoToAll)
    {
       QMessageBox::warning(this,"Gireesh 212218104044","Don't display the message with warning as YesToAll");
    }
...
{
    QMessageBox::StandardButton reply=QMessageBox::question(this,"Gireesh 212218104044","Do you like apples?",QMessageBox::Yes | QMessageBox::No);
